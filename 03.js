...
console.log("1. 원본 객체(student)와 얕은 복사 객체가 같을까요?", "완전히 같습니다.");


//   얕은 복사 객체의 address와 원본 객체의 address를 비교하여 출력해주세요.
console.log("2. 원본 객체의 address와 얕은 복사 객체의 address가 같을까요?", "네");

// 깊은 복사 객체와 원본 객체를 비교하여 출력해주세요.
console.log("3. 원본 객체(student)와 깊은 복사 객체가 같을까요?", "복사 직후 값은 같지만 주소는 다릅니다. 수정하게 되면 수정한 객체에만 업데이트가 이뤄집니다.");

// 깊은 복사 객체의 address와 원본 객체의 address를 비교하여 출력해주세요.
console.log("4. 원본 객체의 address와 깊은 복사 객체의 address가 같을까요?", "다릅니다.");
